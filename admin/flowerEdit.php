            ...
            <div class="col-12 table-responsive">
               ...
               <form  method="POST" action="flowerEdit.php" enctype="multipart/form-data">
                ...
                <div class="form-group mt-30">
                    ...
                    <label>Title</label>
                    <input type="text" name="title" value="<?php echo $row['title']?>" class="form-control" placeholder="title" requird>
                </div>

                  <div class="form-group mt-30">
                     <label>Description</label>
                     <input type="text" name="description" value="<?php echo $row['description']?>" class="form-control" placeholder="description" requird>
                 </div>
                    ...
                    <div class="form-group mt-30">
                        ...
                        <input type="file" name="image"  class="form-control" placeholder="image" required>
                              <img width="100px" src="<?php echo $row['image'] ?>"/>
